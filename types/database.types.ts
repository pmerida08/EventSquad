  ...
  public: {
    Tables: {
      ...
      kick_votes: {
        ...
        Relationships: [
          {
            foreignKeyName: "kick_votes_group_id_fkey"
            columns: ["group_id"]
            isOneToOne: false
            referencedRelation: "groups"
            referencedColumns: ["id"]
      ...
      meetup_votes: {
        ...
        Relationships: [
          ...
          },
          {
            ...
            columns: ["proposal_id"]
            isOneToOne: false
            referencedRelation: "meetup_proposals_with_votes"
            referencedColumns: ["id"]
          },
          {
      ...
      user_reports: {
        ...
        Relationships: [
          {
            foreignKeyName: "user_reports_group_id_fkey"
            columns: ["group_id"]
            isOneToOne: false
            referencedRelation: "groups"
            referencedColumns: ["id"]
    ...
    Functions: {
      ...
      kick_member: {
        Args: { p_group_id: string; p_target_id: string }
        Returns: undefined
      }
      report_user: {
        Args: { p_group_id: string; p_reason: string; p_reported_id: string }
        Returns: undefined
      }
      vote_for_proposal: { Args: { p_proposal_id: string }; Returns: undefined }
      vote_kick_user: {
        Args: { p_group_id: string; p_target_id: string }
        Returns: undefined
      }
